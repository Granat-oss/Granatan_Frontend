...
const WeeklyTransposedTable = ({ data, searchAsin, isParent }) => {
  ...
  const metricsStr = ["Total Sales", "Total Orders", "Total Units", "Sessions", "Amz Conv %", "PPC Spend", "PPC Sales", "PPC Cost / Unit", "PPC Cost / Order", "PPC Orders", "PPC Impressions", "PPC Clicks", "PPC Conv %", "CTR_PPC %", "PPC vs Total %", "Org Conv %", "TACOS %", "ACOS %"];
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', minWidth: '1200px' }}>
                  <thead>
                    <tr style={{ background: 'rgba(255,255,255,0.03)', borderBottom: '1px solid rgba(255,255,255,0.12)' }}>
                      {["Month", "ASIN", "Parent ASIN", "Total Sales", "Total Orders", "Total Units", "Sessions", "Amz Conv %", "PPC Spend", "PPC Sales", "PPC Cost / Unit", "PPC Cost / Order", "PPC Orders", "PPC Impressions", "PPC Clicks", "PPC Conv %", "CTR_PPC %", "PPC vs Total %", "Org Conv %", "TACOS %", "ACOS %"].map(header => (
                        <th
                          key={header}
                  ...
                  <tbody>
                    {filteredMonthlyData.map((row, idx) => (
                      <tr key={idx} style={{ borderBottom: '1px solid rgba(255,255,255,0.12)' }}>
                        {["Month", "ASIN", "Parent ASIN", "Total Sales", "Total Orders", "Total Units", "Sessions", "Amz Conv %", "PPC Spend", "PPC Sales", "PPC Cost / Unit", "PPC Cost / Order", "PPC Orders", "PPC Impressions", "PPC Clicks", "PPC Conv %", "CTR_PPC %", "PPC vs Total %", "Org Conv %", "TACOS %", "ACOS %"].map(col => {
                          let cellVal = row[col];
